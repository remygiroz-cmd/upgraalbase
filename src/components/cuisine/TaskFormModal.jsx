  ...
  const handleGenerateImage = async () => {
    ...
    try {
      const result = await base44.integrations.Core.GenerateImage({
        prompt: `Extreme close-up professional photograph of "${form.name}", macro shot, highly detailed, sharp focus on the dish or ingredient, clean white or minimal background, commercial food photography, studio lighting, photorealistic, 8k quality, subject clearly visible and centered`
      });
      if (result?.url) {
