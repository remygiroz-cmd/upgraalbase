...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-2 text-left pb-4 border-b border-gray-200 mb-4", className)}
    {...props} />
)
...
const SheetFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 pt-4 border-t border-gray-200 mt-4", className)}
    {...props} />
)
