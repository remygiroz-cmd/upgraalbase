...
export default function AddPaidLeaveModal({ open, onOpenChange, employee, existingPeriod = null, embedded = false }) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-green-700">
            {existingPeriod ? '✏️ Modifier' : '➕ Ajouter'} Congés Payés
          </DialogTitle>
