...
import { Send, Clock, Mail, Calendar, CheckCircle, AlertCircle, Settings, PlayCircle } from 'lucide-react';
...
export default function AutomationsComptables() {
  ...
  return (
    <div>
      <PageHeader
        icon={Send}
        title="Automatisations comptables"
        subtitle="Configuration de l'envoi automatique des factures"
        actions={
