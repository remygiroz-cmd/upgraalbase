...
const MODULES = [
  ...
  { key: 'postes_templates', label: 'Postes & Templates RH' },
  { key: 'coffre_factures', label: 'Coffre à factures' },
      ...
      {hasChanges && (
        <div className="fixed bottom-6 right-6 z-40">
          <Button
            ...
            className="bg-orange-600 hover:bg-orange-700 shadow-lg min-h-[48px] px-6 disabled:opacity-50 disabled:cursor-not-allowed"
          >
